...
def infer(images_list,
    ...
    for filename_i, input_filename in enumerate(images_list):
        ...
        del segmentation_output_wo_argmax
...
def main():
    ...
    # ---------------------------------
    # DOCKER
    input_path = '/workspace/inputs/'
    output_path = '/workspace/outputs/'
    localization_module_folder = '/workspace/saved_models/localization'
    segmentation_module_folder = '/workspace/saved_models/segmentation'
    utils_module_folder = '/workspace/saved_models/tf_utils_module'
    # ---------------------------------
